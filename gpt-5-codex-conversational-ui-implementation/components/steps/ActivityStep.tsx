                          ...
                          <div className="activity-card-copy">
                            <div className="activity-card-top">
                              <div>
                                ...
                                <p className="muted">{activity.subtitle || activity.description}</p>
                              </div>
      ...
      {detailsActivity ? (
        <div aria-modal="true" className="hero-modal-backdrop" onClick={() => setDetailsId('')} role="dialog">
          <div className="hero-modal accommodation-modal" onClick={(event) => event.stopPropagation()}>
            ...
            {detailsActivity.imageUrl ? (
              <img alt={detailsActivity.name} className="accommodation-modal-image" src={detailsActivity.imageUrl} />
            ) : null}
            <div className="accommodation-modal-copy">
              ...
              {detailsActivity.gallery.length ? (
                <div>
                  <h3>More photos</h3>
                  <div className="accommodation-modal-gallery">
                    {detailsActivity.gallery.slice(0, 4).map((image) => (
                      <img alt={image.title || detailsActivity.name} key={image.id} src={image.url} />
                    ))}
                  </div>
                </div>
              ) : null}
