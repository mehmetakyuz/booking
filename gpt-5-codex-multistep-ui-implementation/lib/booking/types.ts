export type StepId = 'occupancy' | 'accommodation' | 'activities' | 'flights' | 'cars' | 'checkout'
...
export type ReceiptInstalmentSchedule = ReceiptInstalmentPayment[]
...
export interface ReceiptData {
  ...
  instalmentPayments: ReceiptInstalmentSchedule[]
  errors: ReceiptError[]
}
