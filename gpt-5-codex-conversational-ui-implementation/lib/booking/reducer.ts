import { BookingState, CarExtra, CheckoutData, FlightOption, Message, ReceiptData, StepId } from '@/lib/booking/types'
...
export type BookingAction =
  ...
  | { type: 'SET_ASSISTANT_BUSY'; value: boolean }
...
export function bookingReducer(state: BookingState, action: BookingAction): BookingState {
  switch (action.type) {
    ...
    case 'SET_ASSISTANT_BUSY':
      return { ...state, assistantBusy: action.value }
    default:
      return state
  }
}
