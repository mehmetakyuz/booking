// All GraphQL documents for the booking flow.
//
// Argument-type discipline (see spec-api.md):
//   - offer.calendar(...)  takes LISTS:    nights:[Int], packageGroups:[String], tourUnits:[String]
//   - dynamicPackage*(...) take SINGULARS: nights:Int,  packageGroup:String,    tourUnit:Int
